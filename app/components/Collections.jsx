                ...
                <div className="w-full flex flex-col gap-2">
                  ...
                  <div className="flex gap-4">
                    <Link key={collection?.id} href={`/collections/${collection?.id}`}>
                      <button className="bg-gradient-to-r from-purple-500 to-blue-500 hover:bg-gradient-to-br hover:from-blue-600 hover:to-purple-600 text-white text-xs md:text-sm px-4 py-2 rounded-lg transition-all duration-100">
                        SHOP NOW
                      </button>
                    </Link>
                  </div>
