      ...
      <section className="min-h-screen flex flex-col gap-3 justify-center items-center">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <Link href={checkout?.url}>
            <button className="bg-gradient-to-r from-purple-600 to-blue-600 hover:bg-gradient-to-br hover:from-blue-600 hover:to-purple-600 px-5 py-2 rounded-lg text-white transition-all duration-150">
              Retry
            </button>
          </Link>
        </div>
